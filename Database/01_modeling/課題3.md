...
erDiagram
    ...
    TimeSaleMenuCategory ||--o{ TimeSaleMenuSubCategory : ""
    MenuCategory ||--o{ TimeSaleMenuCategory : ""
    MenuSubCategory ||--o{ TimeSaleMenuSubCategory : ""
...
CREATE TABLE MenuItem (
    ...
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (sub_category_id) REFERENCES MenuSubCategory(id)
);
...
-- タイムセールス対象サブカテゴリー
CREATE TABLE TimeSaleMenuSubCategory (
    id INT PRIMARY KEY AUTO_INCREMENT,
    time_sale_menu_category_id INT,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (time_sale_menu_category_id) REFERENCES TimeSaleMenuCategory(id)
);
```
...
--サブカテゴリーデータ
INSERT INTO MenuSubCategory (menu_category_id, name, description) VALUES (1, '1皿 100円(税別)', '100円(税別)のグループ');
INSERT INTO MenuSubCategory (menu_category_id, name, description) VALUES (2, '盛り込み', '盛り込みのグループ');


-- 商品データ
INSERT INTO MenuItem (sub_category_id, name, price, description, order_method)
...
-- タイムセール対象サブカテゴリー
INSERT INTO TimeSaleMenuSubCategory (time_sale_menu_category_id) Values (1);
